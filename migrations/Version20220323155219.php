 ...
 */
final class Version20220323155219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE groupes (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, hour VARCHAR(5) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
